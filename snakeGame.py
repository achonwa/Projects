...
SEPARATION = 10 #Between two pixels
SCREEN_HEIGHT = 600
SCREEN_WIDTH = 800
FPS = 25
...
#to check if the boundaries are not limited
...
#creating a food class for the snake calling it Apple
...
class Apple:
    def __init__(self,x,y,state):
        ...
        self.y = y 
        self.state = state
        self.color = pygame.color.Color("orange") #color of the food of the the snake 
...
class snake:
    def __init__(self,x,y):
        ...
        self.y = y 
        self.direction = KEY["UP"]
        self.stack = []  #will initially be empty
    ...
    #defining the moves of the snake
    ...
    def getHead(self):  # headof the snake and it will always be t index 0
        return(self.stack[0])
    #when food is added it will extend
    ...
    #creating crash function when the snake eats its self during the  game
